                ...
                <table class="table fs--1 mb-0">
                  ...
                  <tbody class="list" id="table-latest-review-body">
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/1.png')}}" alt="" width="53"></td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/2.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                        <h6 class="fw-semi-bold mb-0">iPhone 13 pro max-Pacific Blue-128GB storage</h6>
                      </td>
                      <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                          <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/59.png')}}" alt=""></div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/3.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                        <h6 class="fw-semi-bold mb-0">Apple MacBook Pro 13 inch-M1-8/256GB-space</h6>
                      </td>
                      <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                          <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/58.png')}}" alt=""></div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/4.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                        <h6 class="fw-semi-bold mb-0">Apple iMac 24&quot; 4K Retina Display M1 8 Core CPU...</h6>
                      </td>
                      <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                          <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/avatar-placeholder.png')}}" alt=""></div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/5.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/6.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                        <h6 class="fw-semi-bold mb-0">PlayStation 5 DualSense Wireless Controller</h6>
                      </td>
                      <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                          <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/57.png')}}" alt=""></div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/7.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                        <h6 class="fw-semi-bold mb-0">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, 128GB) -...</h6>
                      </td>
                      <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                          <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/3.png')}}" alt=""></div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/8.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                        <h6 class="fw-semi-bold mb-0">Amazon Basics Matte Black Wired Keyboard - US ...</h6>
                      </td>
                      <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                          <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/26.png')}}" alt=""></div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/9.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                        <h6 class="fw-semi-bold mb-0">Amazon Basics Mesh, Mid-Back, Swivel Office De...</h6>
                      </td>
                      <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                          <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/29.png')}}" alt=""></div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/10.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/11.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                        <h6 class="fw-semi-bold mb-0">Echo Dot (4th Gen) _ Smart speaker with Alexa ...</h6>
                      </td>
                      <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                          <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/8.png')}}" alt=""></div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/12.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/13.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                        <h6 class="fw-semi-bold mb-0">Nintendo Switch with Neon Blue and Neon Red Jo...</h6>
                      </td>
                      <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                          <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/9.png')}}" alt=""></div>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/14.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle product white-space-nowrap py-0"><img src="{{asset('dashassets/img/products/15.png')}}" alt="" width="53"></td>
                      <td class="align-middle product white-space-nowrap">
                        <h6 class="fw-semi-bold mb-0">Sony X85J 75 Inch Sony 4K Ultra HD LED Smart G...</h6>
                      </td>
                      <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                          <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('dashassets/img/team/24.png')}}" alt=""></div>
                      ...
                      <td class="white-space-nowrap ps-0" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">1.</h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="{{asset('dashassets/img/country/india.png')}}" alt="" width="24">
                      ...
                      <td class="white-space-nowrap ps-0" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">2.</h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="{{asset('dashassets/img/country/china.png')}}" alt="" width="24">
                      ...
                      <td class="white-space-nowrap ps-0" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">3.</h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="{{asset('dashassets/img/country/usa.png')}}" alt="" width="24">
                      ...
                      <td class="white-space-nowrap ps-0" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">4.</h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="{{asset('dashassets/img/country/south-korea.png')}}" alt="" width="24">
                      ...
                      <td class="white-space-nowrap ps-0" style="width:32%">
                        <div class="d-flex align-items-center">
                          <h6 class="mb-0 me-3">5.</h6><a href="#!">
                            <div class="d-flex align-items-center"><img src="{{asset('dashassets/img/country/vietnam.png')}}" alt="" width="24">
